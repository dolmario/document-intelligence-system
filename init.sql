...
-- Hash-based duplicate prevention indexes
...
-- Enhanced stats view with duplicate detection info
...
-- Utility view for monitoring processing queue
...
DO $$ 
BEGIN
    RAISE NOTICE 'Document Intelligence System database initialized successfully';
