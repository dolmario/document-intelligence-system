```markdown
# 📁 Semantic Document Finder System (WIP 🚧)
...
[![Tests](https://github.com/[USERNAME]/semantic-doc-finder-system/actions/workflows/test.yml/badge.svg)](https://github.com/[USERNAME]/semantic-doc-finder-system/actions/workflows/test.yml)
[![Docker](https://img.shields.io/docker/pulls/[USERNAME]/semantic-doc-finderligence)](https://hub.docker.com/r/[USERNAME]/semantic-doc-finderligence)
...
```powershell
git clone https://github.com/[USERNAME]/semantic-doc-finder-system.git
cd semantic-doc-finder-system
.\install.ps1
```
...
docker exec -it semantic-doc-finder-system-ollama-1 ollama pull mistral
docker exec -it semantic-doc-finder-system-ollama-1 ollama pull llama3
```
...
docker exec -it semantic-doc-finder-system-ollama-1 ollama list

# Neues Modell laden
docker exec -it semantic-doc-finder-system-ollama-1 ollama pull codellama
...
# Redis Queue Status
docker exec -it semantic-doc-finder-system-redis-1 redis-cli
...
- Issues: [GitHub Issues](https://github.com/[USERNAME]/semantic-doc-finder-system/issues)
- Discussions: [GitHub Discussions](https://github.com/[USERNAME]/semantic-doc-finder-system/discussions)
- Wiki: [Project Wiki](https://github.com/[USERNAME]/semantic-doc-finder-system/wiki)
```
